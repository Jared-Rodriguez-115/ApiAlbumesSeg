...
namespace ApiAlbumesSeg.Controllers
{
    ...
    public class CuentasController: ControllerBase
    {
        ...
        public async Task<ActionResult<RespuestaAutenticacion>> Registrar(CredencialesUsuario credenciales)
        {
            ...
            if (result.Succeeded)
            {
                //Aqui se retorna el Json Web Token especificando el formato del token que hay que devolver a los clientes 
        ...
        {
            //Informacion del usuario en la que podremos confiar

            var claims = new List<Claim>
            {
                new Claim("email", credencialesUsuario.Email),
                new Claim("claimprueba", "Claim de prueba")
            };
